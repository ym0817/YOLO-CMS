...
if __name__ == "__main__":
    ...
    model = MCnet(YOLOP)
    checkpoint = torch.load('./weights/epoch-181.pth', map_location=device)
    # checkpoint = torch.load('epoch-20.pth', map_location=device)
    ...
    onnx_path = f'./weights/epoch-181-{height}-{width}.onnx'
    ...
    # output_names = ['det_out',  'lane_line_seg']
