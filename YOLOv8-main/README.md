...
equires-Python >=3.8; 8.0.208 Requires-Python >=3.8
...
1 使用检测模型
yolo task=detect mode=predict model = yolov8n.pt source =“zidane.jpg”
yolo task=detect mode=predict model=yolov8x.pt source='input/video_3.mp4' show=True

2、从YAML中构建一个新模型，并从头开始训练
...
# 自己从头训练
yolo task=detect mode=train model=yolov8n.yaml  data=score_data.yaml device=0 epochs=300 batch=128 imgsz=640 pretrained=False optimizer=SGD 


3.pretrained训练
nohup yolo task=detect mode=train data=score_data.yaml device=0 epochs=300 batch=64 imgsz=640 pretrained=True model=runs_coco/detect/train/weights/last.pt lr0=0.001 lrf=0.001 optimizer=SGD > nohup1.out 2>&1 &


yolo task=detect mode=train model=yolov8n.yaml  data=score_data.yaml device=0 epochs=300 batch=64 imgsz=640 pretrained=True model=runs0/detect/train/weights/last.pt optimizer=SGD


nohup yolo task=detect mode=train model=yolov8n.yaml  data=score_data.yaml device=0 epochs=300 batch=64 imgsz=640 pretrained=True model=runs0/detect/train/weights/last.pt optimizer=SGD > nohup1.out 2>&1 &



4.resume训练
nohup yolo task=detect mode=train data=score_data.yaml device=0 epochs=300 batch=64 imgsz=640 pretrained=True model=runs3/detect/train/weights/last.pt lr0=0.0004 lrf=0.0004 optimizer=SGD > nohup1.out 2>&1 &

nohup yolo task=detect mode=train data=score_data.yaml device=0 epochs=300 batch=64 imgsz=640 resume=True model=runs3/detect/train/weights/last.pt lr0=0.0004 lrf=0.0004 optimizer=SGD > nohup1.out 2>&1 &

tail -f nohup1.out


3、在 COCO128 val 上验证 YOLOv8n
yolo task=detect mode=val model=yolov8n.yaml  data=score_data.yaml
