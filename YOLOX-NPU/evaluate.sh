...
D:\Workspace\CMS\ZG_A\YOLOX2\YOLOX-NPU\YOLOX-NPU\yolox_nano_6c\model_last.pth

python evaluate.py gpus='0' backbone="CSPDarknet-nano" load_model="model_best_hs.pth" batch_size=2 fuse=True
